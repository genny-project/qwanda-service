...
public class QwandaEndpoint {
	...
	public Response fetchBaseEntityByCode(@PathParam("sourceCode") final String code) {
	...
	@Produces("application/json")
	public Response getTargets(@PathParam("sourceCode") final String sourceCode,@DefaultValue("LNK_CORE") @PathParam("linkCode") final String linkCode) {
	    ...
	    public Response uploadFile(final MultipartFormDataInput input) throws IOException {
	        ...
	        for (final InputPart inputPart : inputParts) {
	            try {
	                ...
	                final InputStream inputStream = inputPart.getBody(InputStream.class,
	                        null);
